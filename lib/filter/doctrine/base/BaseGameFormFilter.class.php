...
abstract class BaseGameFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'scheduled_time'        => new sfWidgetFormFilterInput(),
      'created_at'            => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate(), 'with_empty' => false)),
      'updated_at'            => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate(), 'with_empty' => false)),
    ));

    $this->setValidators(array(
      'game_configuration_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('GameConfiguration'), 'column' => 'id')),
      'title'                 => new sfValidatorPass(array('required' => false)),
      'scheduled_time'        => new sfValidatorPass(array('required' => false)),
  ...
  public function getFields()
  {
    return array(
      'id'                    => 'Number',
      'game_configuration_id' => 'ForeignKey',
      'title'                 => 'Text',
      'scheduled_time'        => 'Text',
      'created_at'            => 'Date',
      'updated_at'            => 'Date',
