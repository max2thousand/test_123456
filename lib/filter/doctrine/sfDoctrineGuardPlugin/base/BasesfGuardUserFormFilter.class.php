...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  ...
  public function addSuperenalottoWinsListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('SuperenalottoWinUser.superenalotto_win_id', $values)
    ;
  }
  ...
  public function getFields()
  {
    return array(
      ...
      'superenalotto_wins_list' => 'ManyKey',
    );
  }
}
