...
<div id="ctr" align="center">
  <div class="login">
    ...
    <div class="login-text">
      <div class="ctr"><img style="width:170px;" src="<?php echo image_path('/sfAdminDashPlugin/images/login_security.png'); ?>" /></div>
      <p><?php echo __('Welcome to', array(), 'sf_admin_dash'); ?> <b> <?php echo sfAdminDash::getProperty('site'); ?></b></p>
